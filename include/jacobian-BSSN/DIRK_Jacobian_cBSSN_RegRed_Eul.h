...
Jacobian[6][6]=
    ...
    /*0*/  * (-gA1(m,n) - (exp(-2 * gconf(m,n)) * gDA(m,n) 
    /*2*/  * p(m,n)) / (gA(m,n) * Lt(m,n)));
...
Jacobian[7][7]=
    ...
    /*0*/  * (gA1(m,n) / 2. + p(m,n) * (-((exp(-2 * gconf(m,n))
    /*4*/  * (1 + gDB(m,n) * r(m,n))) / (gA(m,n) * Lt(m,n) 
    /*4*/  * r(m,n))) + (exp(-2 * gconf(m,n)) * (1 + gDB(m,n) 
    /*4*/  * r(m,n))) / (gA(m,n) * r(m,n) * Lt(m,n))));
...
Jacobian[10][10]=
    ...
    /*0*/  * gBet(m,n) - (exp(-2 * gconf(m,n)) * fDA(m,n) 
    /*1*/  * gAlp(m,n) * p(m,n)) / (gA(m,n) * Lt(m,n));
...
Jacobian[11][11]=
	fDB(m,n) * gBet(m,n) + gBetr(m,n) - (exp(-2 
    /*2*/  * gconf(m,n)) * gAlp(m,n) * p(m,n) * (1 + fDB(m,n) 
    /*2*/  * r(m,n))) / (gA(m,n) * Lt(m,n) * r(m,n)) 
    /*0*/  + fAlp(m,n) * (fA1(m,n) / 2. - (exp(-2 * fconf(m,n))
...
Jacobian[11][25]=
	(exp(-2 * fconf(m,n) + 2 * gconf(m,n)) * gB(m,n) 
    /*1*/  * (1 + fDB(m,n) * r(m,n)) * R(m,n)) / r(m,n);
...
Jacobian[16][6]=
    ...
    /*0*/  / (3. * pow3(gA(m,n))) - (4 * k_g * exp(2 
    /*2*/  * fconf(m,n)) * fA(m,n) * gAlp(m,n) * p(m,n) 
    /*1*/  * P_2_1(R(m,n))) / pow3(gA(m,n)) + gAlp(m,n) * ((-8
    /*2*/  * (gAsig(m,n) * pow2(r(m,n)) * (gDA(m,n) 
    /*4*/  + gDB(m,n) + 6 * gDconf(m,n) + gsig(m,n) * r(m,n)) 
    /*3*/  - gtrK_r(m,n))) / (3. * pow3(gA(m,n))) + (exp(-2 
    /*3*/  * gconf(m,n)) * p(m,n) * (2 - gL_r(m,n) 
    /*3*/  * pow2(gB(m,n)) * pow2(r(m,n)))) / (pow2(gA(m,n)) 
...
Jacobian[17][10]=
    ...
    /*0*/  / (3. * pow3(fA(m,n))) + (4 * k_f * exp(2 
    /*2*/  * gconf(m,n)) * fAlp(m,n) * gA(m,n) * p(m,n) 
    /*1*/  * P_2_1(R(m,n))) / (pow2(R(m,n)) * pow3(fA(m,n))) 
    /*0*/  + fAlp(m,n) * ((-8 * (fAsig(m,n) * pow2(r(m,n)) 
    /*3*/  * (fDA(m,n) + fDB(m,n) + 6 * fDconf(m,n) + fsig(m,n)
    /*4*/  * r(m,n)) - ftrK_r(m,n))) / (3. * pow3(fA(m,n))) 
    /*1*/  + (exp(-2 * fconf(m,n)) * p(m,n) * (fL_r(m,n) - (2 
    /*4*/  * exp(4 * fconf(m,n) - 4 * gconf(m,n))) 
    /*3*/  / (pow2(gB(m,n)) * pow2(r(m,n)) * pow2(R(m,n))))) 
...
Jacobian[20][7]=
    ...
    /*3*/  * (2 * gL(m,n) * gsig(m,n) + gsig_gL_r(m,n) 
...
Jacobian[20][20]=
    ...
    /*1*/  * ((-2 * exp(-2 * gconf(m,n))) / (gA(m,n) * Lt(m,n)
...
Jacobian[25][25]=
	gBet_r(m,n) - (exp(-2 * gconf(m,n)) * gAlp_r(m,n)
    /*1*/  * p(m,n)) / (gA(m,n) * Lt(m,n)) + gAlp(m,n) 
    /*0*/  * (-((exp(-2 * gconf(m,n)) * p_r(m,n)) / (gA(m,n) 
    /*3*/  * Lt(m,n))) + p(m,n) * (((2 * exp(-2 * gconf(m,n)) 
    /*4*/  * gconf_r(m,n)) / gA(m,n) + (exp(-2 * gconf(m,n)) 
    /*4*/  * gA_r(m,n)) / pow2(gA(m,n))) / Lt(m,n) + (exp(-2 
    /*4*/  * gconf(m,n)) * Lt_r(m,n)) / (gA(m,n) 
    /*3*/  * pow2(Lt(m,n)))));
...
Jacobian[26][6]=
    ...
    /*2*/  * gBet_r(m,n) * r(m,n))) / (3. * pow2(r(m,n)) 
    /*1*/  * pow3(gA(m,n))) + pow3(gAlp(m,n)) * ((-8 
    /*2*/  * (gAsig(m,n) * pow2(r(m,n)) * (gDA(m,n) + gDB(m,n)
    /*4*/  + 6 * gDconf(m,n) + gsig(m,n) * r(m,n)) 
...
Jacobian[26][25]=
	Bq_r(m,n) + pow2(gAlp(m,n)) * ((gDA_r(m,n) + 2 
    /*2*/  * gDB_r(m,n) - 2 / pow2(r(m,n))) / (3. 
    /*2*/  * pow2(gA(m,n))) + (-6 + 2 * gL(m,n) * pow2(gB(m,n))
    /*2*/  * r(m,n) * (2 + gDA(m,n) * r(m,n) + 2 * gDB(m,n) 
