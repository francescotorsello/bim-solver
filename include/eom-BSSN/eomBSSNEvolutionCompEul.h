...
Real gtrK_t( Int m, Int n )
{
    ...
    /*0*/  / (pow2(r_plus(m,n)) * pow2(gA(m,n)) + TINY_Real ) + gAlp_r(m,n) * ((-2 * Power(r_minus(m,n),4)
    /*2*/  * exp(-4 * gconf(m,n)) * gconf_r(m,n)) / (pow2(r_plus(m,n)) * pow2(gA(m,n)) + TINY_Real ) - (2
    /*2*/  * Power(r_minus(m,n),4) * exp(-4 * gconf(m,n)) * gB_r(m,n)) / (gB(m,n)
    /*2*/  * pow2(r_plus(m,n)) * pow2(gA(m,n)) + TINY_Real ) + (Power(r_minus(m,n),4) * exp(-4 * gconf(m,n))
    /*2*/  * gA_r(m,n)) / (pow2(r_plus(m,n)) * pow3(gA(m,n)) + TINY_Real ) - (2 * Power(r_minus(m,n),4) * exp(-4
    /*3*/  * gconf(m,n))) / (pow2(gA(m,n)) * pow3(r_plus(m,n)) * r(m,n) + TINY_Real )) + gAlp(m,n) * (3
    /*1*/  * pow2(gA1(m,n)) - (4 * gA1(m,n) * gAsig(m,n) * pow2(r(m,n))) / (pow2(r_minus(m,n)) + TINY_Real )
    /*1*/  + pow2(gtrK(m,n)) / 3. + (2 * pow2(gAsig(m,n)) * Power(r(m,n),4))
    /*1*/  / (Power(r_minus(m,n),4) + TINY_Real )) + (gBet(m,n) * pow2(r_minus(m,n)) * gtrK_r(m,n)) / (r_plus(m,n) + TINY_Real );
}
Real ftrK_t( Int m, Int n )
{
    ...
    /*2*/  * exp(-4 * fconf(m,n)) * fconf_r(m,n)) / (pow2(r_plus(m,n)) * pow2(fA(m,n)) + TINY_Real ) - (2
    /*2*/  * Power(r_minus(m,n),4) * exp(-4 * fconf(m,n)) * fB_r(m,n)) / (fB(m,n)
    /*2*/  * pow2(r_plus(m,n)) * pow2(fA(m,n)) + TINY_Real ) + (Power(r_minus(m,n),4) * exp(-4 * fconf(m,n))
    /*2*/  * fA_r(m,n)) / (pow2(r_plus(m,n)) * pow3(fA(m,n)) + TINY_Real ) - (2 * Power(r_minus(m,n),4) * exp(-4
    /*3*/  * fconf(m,n))) / (pow2(fA(m,n)) * pow3(r_plus(m,n)) * r(m,n) + TINY_Real )) + fAlp(m,n) * (3
    /*1*/  * pow2(fA1(m,n)) - (4 * fA1(m,n) * fAsig(m,n) * pow2(r(m,n))) / (pow2(r_minus(m,n)) + TINY_Real )
    /*1*/  + pow2(ftrK(m,n)) / 3. + (2 * pow2(fAsig(m,n)) * Power(r(m,n),4) )
    /*1*/  / (Power(r_minus(m,n),4) + TINY_Real )) + (fBet(m,n) * pow2(r_minus(m,n)) * ftrK_r(m,n)) / r_plus(m,n);
}
...
Real gB_t( Int m, Int n )
{
    ...
    /*2*/  / ( pow2(r_minus(m,n)) + TINY_Real ) )) / 3.;
}
...
Real gL_t( Int m, Int n )
{
    ...
    /*3*/  + gBetr_r(m,n) * r(m,n))) / (pow2(gB(m,n)) * (r(m,n) + Power(r(m,n),3)) + TINY_Real ) + (2
    ...
    /*2*/  * (r(m,n) + Power(r(m,n),3)) + TINY_Real ) - (2 * pow2(r_minus(m,n)) * (-6 * gBet_r(m,n)
    /*3*/  * r(m,n) * (-3 + 2 * pow2(r(m,n)) + Power(r(m,n),4)) + (1 + pow2(r(m,n)))
    /*3*/  * (-3 * gBet_rr(m,n) * pow2(r_minus(m,n)) + 4 * gAlp(m,n) * (1 + pow2(r(m,n)))
    /*4*/  * gtrK_r(m,n)))) / (pow2(gA(m,n)) * pow3(r_plus(m,n)) + TINY_Real )) / 6.;
}
Real fL_t( Int m, Int n )
{
    ...
    /*1*/  / (r_plus(m,n) * fB(m,n) * pow3(fA(m,n)) + TINY_Real ) - (8 * fAlp(m,n) * (fA_r(m,n) * fB(m,n)
    /*3*/  + fA(m,n) * (6 * fconf_r(m,n) * fB(m,n) + fB_r(m,n))) * (fA1(m,n)
    /*3*/  * pow2(r_minus(m,n)) - fAsig(m,n) * pow2(r(m,n)))) / (r_plus(m,n) * fB(m,n)
    /*2*/  * pow3(fA(m,n)) + TINY_Real ) + (12 * pow2(r_minus(m,n)) * (fBet_r(m,n) * (-1 + pow2(r(m,n)))
    /*3*/  + fBetr_r(m,n) * r(m,n))) / (pow2(fB(m,n)) * (r(m,n) + Power(r(m,n),3)) + TINY_Real ) + (2
    ...
    /*2*/  * (r(m,n) + Power(r(m,n),3)) + TINY_Real ) - (2 * pow2(r_minus(m,n)) * (-6 * fBet_r(m,n)
    /*3*/  * r(m,n) * (-3 + 2 * pow2(r(m,n)) + Power(r(m,n),4)) + (1 + pow2(r(m,n)))
    /*3*/  * (-3 * fBet_rr(m,n) * pow2(r_minus(m,n)) + 4 * fAlp(m,n) * (1 + pow2(r(m,n)))
    /*4*/  * ftrK_r(m,n)))) / (pow2(fA(m,n)) * pow3(r_plus(m,n)) + TINY_Real )) / 6.;
}
...
Real gAsig_t( Int m, Int n )
{
    ...
    /*2*/  / (gB(m,n) * pow2(r_plus(m,n)) * pow3(gA(m,n)) + TINY_Real ) + (exp(-4 * gconf(m,n)) * gAlp(m,n)
    /*3*/  * pow2(gB(m,n)) * r(m,n) * (-2 * gL(m,n) * gsig(m,n) * pow2(gA(m,n)) - (2
    /*5*/  * pow2(gsig(m,n)) * r(m,n)) / (r_minus(m,n) + TINY_Real ) + (gsig_r(m,n) * (-1 + pow2(r(m,n)))
    /*5*/  * (-4 + 4 * pow2(r(m,n)) + gL(m,n) * pow2(gA(m,n)) * r(m,n))) / r_plus(m,n)
    /*4*/  - (pow2(r_minus(m,n)) * r(m,n) * (2 * gsig_r(m,n) * (3 + pow2(r(m,n))) * r(m,n)
    /*6*/  + gsig_rr(m,n) * (-1 + Power(r(m,n),4)))) / pow3(r_plus(m,n)))) / ( Power(gA(m,n),4)  + TINY_Real )
    ...
    /*6*/  - gAlp(m,n) * r(m,n) * gtrK(m,n))) / ( pow2(r_minus(m,n)) + TINY_Real )  )) / (Power(gA(m,n),4) + TINY_Real ) ))
    /*0*/  / (2. * pow2(r(m,n)) + TINY_Real );
}
Real fAsig_t( Int m, Int n )
{
    ...
    /*2*/  / (fB(m,n) * pow2(r_plus(m,n)) * pow3(fA(m,n)) + TINY_Real ) + (exp(-4 * fconf(m,n)) * fAlp(m,n)
    /*3*/  * pow2(fB(m,n)) * r(m,n) * (-2 * fL(m,n) * fsig(m,n) * pow2(fA(m,n)) - (2
    /*5*/  * pow2(fsig(m,n)) * r(m,n)) / ( r_minus(m,n) + TINY_Real ) + (fsig_r(m,n) * (-1 + pow2(r(m,n)))
    ...
    /*6*/  - fAlp(m,n) * r(m,n) * ftrK(m,n))) / ( pow2(r_minus(m,n))  + TINY_Real ) )) / ( Power(fA(m,n),4)  + TINY_Real ) ))
    /*0*/  / (2. * pow2(r(m,n)) + TINY_Real );
}
