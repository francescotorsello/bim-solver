/** @file  eomBSSNEvolutionDconf.h
 *  @author Francesco Torsello
 *  @brief The regularized cBSSN evolution equations.
 *  @version 2018-12-14T11:22:31
 *  @image html BSSNevolutionDconf.png
 */
...
{
    return -(gdet_pff_r(m,n) / ((12 + TINY_Real) * gdet(m,n))) + gDconf(m,n) 
    /*0*/  * gBet_r(m,n) + (gdet_pff(m,n) * gdet_r(m,n)) / ((12 + TINY_Real) 
    /*1*/  * pow2(gdet(m,n))) - (gDAlp(m,n) * (gtrA(m,n) + gtrK(m,n))) / (6 + TINY_Real)
    /*0*/  + (12 * gDconf_convr(m,n) - 2 * gAlp(m,n) * (gtrA_r(m,n) + gtrK_r(m,n))) 
    /*0*/  / (12 + TINY_Real);
}
Real BimetricEvolve::eq_fDconf_t( Int m, Int n )
{
    return -(fdet_pff_r(m,n) / ((12 + TINY_Real) * fdet(m,n))) + fDconf(m,n) 
    /*0*/  * fBet_r(m,n) + (fdet_pff(m,n) * fdet_r(m,n)) / ((12 + TINY_Real) 
    /*1*/  * pow2(fdet(m,n))) - (fDAlp(m,n) * (ftrA(m,n) + ftrK(m,n))) / (6 + TINY_Real)
    /*0*/  + (12 * fDconf_convr(m,n) - 2 * fAlp(m,n) * (ftrA_r(m,n) + ftrK_r(m,n))) 
    /*0*/  / (12 + TINY_Real);
}
Real BimetricEvolve::eq_gtrK_t( Int m, Int n )
{
    ...
    /*1*/  - gDAlp_r(m,n) / pow2(gA(m,n)) + gDAlp(m,n) * ((-2 * gDconf(m,n)) 
    /*2*/  / pow2(gA(m,n)) - 2 / (pow2(gA(m,n)) * r(m,n)))) - gtrA_pff(m,n) + (gAlp(m,n)
    /*1*/  * (3 * pow2(gA1(m,n)) + 6 * pow2(gA2(m,n)) + gtrK(m,n) * (2 * gtrA(m,n) 
    /*3*/  + gtrK(m,n)))) / 3.;
}
Real BimetricEvolve::eq_ftrK_t( Int m, Int n )
{
    ...
    /*1*/  - fDAlp_r(m,n) / pow2(fA(m,n)) + fDAlp(m,n) * ((-2 * fDconf(m,n)) 
    /*2*/  / pow2(fA(m,n)) - 2 / (pow2(fA(m,n)) * r(m,n)))) - ftrA_pff(m,n) + (fAlp(m,n)
    /*1*/  * (3 * pow2(fA1(m,n)) + 6 * pow2(fA2(m,n)) + ftrK(m,n) * (2 * ftrA(m,n) 
    /*3*/  + ftrK(m,n)))) / 3.;
}
...
Real BimetricEvolve::eq_gA1_t( Int m, Int n )
{
    ...
    /*2*/  * pow2(gA(m,n))) + gDAlp(m,n) * ((8 * gDconf(m,n)) / (3. * pow2(gA(m,n))) + 2
    /*2*/  / (3. * pow2(gA(m,n)) * r(m,n)))) + gtrA_pff(m,n) / 3. + gAlp(m,n) 
    /*0*/  * (exp(-4 * gconf(m,n)) * ((4 * gDA(m,n) * gDconf(m,n)) / (3. 
    /*3*/  * pow2(gA(m,n))) + (4 * gDB(m,n) * gDconf(m,n)) / (3. * pow2(gA(m,n))) - (4 
    /*3*/  * gDconf_r(m,n)) / (3. * pow2(gA(m,n))) + (8 * pow2(gDconf(m,n))) / (3. 
    /*3*/  * pow2(gA(m,n))) + (4 * gDconf(m,n)) / (3. * pow2(gA(m,n)) * r(m,n))) + ((3 
    /*3*/  * gA1(m,n) - gtrA(m,n)) * (gtrA(m,n) + gtrK(m,n))) / 3.);
}
Real BimetricEvolve::eq_gA2_t( Int m, Int n )
{
    ...
    /*1*/  + gDAlp(m,n) * ((-4 * gDconf(m,n)) / (3. * pow2(gA(m,n))) - 1 / (3. 
    /*3*/  * pow2(gA(m,n)) * r(m,n)))) + gtrA_pff(m,n) / 3. + gAlp(m,n) * (exp(-4 
    /*2*/  * gconf(m,n)) * ((-2 * gDA(m,n) * gDconf(m,n)) / (3. * pow2(gA(m,n))) - (2 
    /*3*/  * gDB(m,n) * gDconf(m,n)) / (3. * pow2(gA(m,n))) + (2 * gDconf_r(m,n)) / (3.
    /*3*/  * pow2(gA(m,n))) - (4 * pow2(gDconf(m,n))) / (3. * pow2(gA(m,n))) - (2 
...
Real BimetricEvolve::eq_fA1_t( Int m, Int n )
{
    ...
    /*2*/  * pow2(fA(m,n))) + fDAlp(m,n) * ((8 * fDconf(m,n)) / (3. * pow2(fA(m,n))) + 2
    /*2*/  / (3. * pow2(fA(m,n)) * r(m,n)))) + ftrA_pff(m,n) / 3. + fAlp(m,n) 
    /*0*/  * (exp(-4 * fconf(m,n)) * ((4 * fDA(m,n) * fDconf(m,n)) / (3. 
    /*3*/  * pow2(fA(m,n))) + (4 * fDB(m,n) * fDconf(m,n)) / (3. * pow2(fA(m,n))) - (4 
    /*3*/  * fDconf_r(m,n)) / (3. * pow2(fA(m,n))) + (8 * pow2(fDconf(m,n))) / (3. 
    /*3*/  * pow2(fA(m,n))) + (4 * fDconf(m,n)) / (3. * pow2(fA(m,n)) * r(m,n))) + ((3 
    /*3*/  * fA1(m,n) - ftrA(m,n)) * (ftrA(m,n) + ftrK(m,n))) / 3.);
}
Real BimetricEvolve::eq_fA2_t( Int m, Int n )
{
    ...
    /*1*/  + fDAlp(m,n) * ((-4 * fDconf(m,n)) / (3. * pow2(fA(m,n))) - 1 / (3. 
    /*3*/  * pow2(fA(m,n)) * r(m,n)))) + ftrA_pff(m,n) / 3. + fAlp(m,n) * (exp(-4 
    /*2*/  * fconf(m,n)) * ((-2 * fDA(m,n) * fDconf(m,n)) / (3. * pow2(fA(m,n))) - (2 
    /*3*/  * fDB(m,n) * fDconf(m,n)) / (3. * pow2(fA(m,n))) + (2 * fDconf_r(m,n)) / (3.
    /*3*/  * pow2(fA(m,n))) - (4 * pow2(fDconf(m,n))) / (3. * pow2(fA(m,n))) - (2 
...
Real BimetricEvolve::eq_gL_t( Int m, Int n )
{
    ...
    /*1*/  * pow2(gA(m,n))) + (8 * gAsig(m,n) * gDconf(m,n) * gAlp(m,n) * pow2(r(m,n)))
    /*0*/  / pow2(gA(m,n)) + (4 * gAsig(m,n) * gAlp(m,n) * gsig(m,n) * pow3(r(m,n))) 
    /*0*/  / (3. * pow2(gA(m,n))) + (gDAlp(m,n) * (-6 * gA1(m,n) + 2 * gtrA(m,n))) / (3.
...
Real BimetricEvolve::eq_fL_t( Int m, Int n )
{
    ...
    /*1*/  * pow2(fA(m,n))) + (8 * fAsig(m,n) * fDconf(m,n) * fAlp(m,n) * pow2(r(m,n)))
    /*0*/  / pow2(fA(m,n)) + (4 * fAsig(m,n) * fAlp(m,n) * fsig(m,n) * pow3(r(m,n))) 
    /*0*/  / (3. * pow2(fA(m,n))) + (fDAlp(m,n) * (-6 * fA1(m,n) + 2 * ftrA(m,n))) / (3.
...
Real BimetricEvolve::eq_gAsig_t( Int m, Int n )
{
    ...
    /*1*/  / (pow2(gA(m,n)) * pow2(r(m,n))) + (4 * gDconf(m,n) * gDAlp(m,n)) 
    /*1*/  / (pow2(gA(m,n)) * pow2(r(m,n))) - gDAlpr_r(m,n) / (pow2(gA(m,n)) * r(m,n)))
    /*0*/  + gAlp(m,n) * (exp(-4 * gconf(m,n)) * ((gsig_rr(m,n) * pow2(gB(m,n))) / (2.
    /*3*/  * Power(gA(m,n),4)) + (pow2(gsig(m,n)) * pow2(gB(m,n))) / Power(gA(m,n),4)
    /*2*/  + gDA(m,n) * ((-4 * gDB(m,n)) / (pow2(gA(m,n)) * pow2(r(m,n))) + (2 
    /*4*/  * gDconf(m,n)) / (pow2(gA(m,n)) * pow2(r(m,n)))) + (2 * gDB(m,n) 
    /*3*/  * gDconf(m,n)) / (pow2(gA(m,n)) * pow2(r(m,n))) + (3 * pow2(gDA(m,n))) 
    /*2*/  / (pow2(gA(m,n)) * pow2(r(m,n))) + (4 * pow2(gDconf(m,n))) / (pow2(gA(m,n)) 
...
Real BimetricEvolve::eq_fAsig_t( Int m, Int n )
{
    ...
    /*1*/  / (pow2(fA(m,n)) * pow2(r(m,n))) + (4 * fDconf(m,n) * fDAlp(m,n)) 
    /*1*/  / (pow2(fA(m,n)) * pow2(r(m,n))) - fDAlpr_r(m,n) / (pow2(fA(m,n)) * r(m,n)))
    /*0*/  + fAlp(m,n) * (exp(-4 * fconf(m,n)) * ((fsig_rr(m,n) * pow2(fB(m,n))) / (2.
    /*3*/  * Power(fA(m,n),4)) + (pow2(fsig(m,n)) * pow2(fB(m,n))) / Power(fA(m,n),4)
    /*2*/  + fDA(m,n) * ((-4 * fDB(m,n)) / (pow2(fA(m,n)) * pow2(r(m,n))) + (2 
    /*4*/  * fDconf(m,n)) / (pow2(fA(m,n)) * pow2(r(m,n)))) + (2 * fDB(m,n) 
    /*3*/  * fDconf(m,n)) / (pow2(fA(m,n)) * pow2(r(m,n))) + (3 * pow2(fDA(m,n))) 
    /*2*/  / (pow2(fA(m,n)) * pow2(r(m,n))) + (4 * pow2(fDconf(m,n))) / (pow2(fA(m,n)) 
