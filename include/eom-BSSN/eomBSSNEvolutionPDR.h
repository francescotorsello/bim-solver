...
Real BimetricEvolve::eq_gDsig_t( Int m, Int n )
{
    ...
    /*3*/  - gDB(m,n))) * gAlp(m,n) * pow2(gA(m,n))) / (gsig(m,n) * pow2(gB(m,n))) 
    /*0*/  + (2 * gAsig(m,n) * gDAlp(m,n) * gAlp(m,n) * pow2(gA(m,n))) / (gsig(m,n) 
    /*1*/  * pow2(gB(m,n))) - (2 * gBet(m,n)) / pow2(r(m,n)) - (2 * gBet_rr(m,n) 
    /*1*/  * pow2(gA(m,n))) / (gsig(m,n) * pow2(gB(m,n)) * pow2(r(m,n))) + gDsig(m,n) 
    /*0*/  * ((-2 * gAsig(m,n) * gAlp(m,n) * pow2(gA(m,n))) / (gsig(m,n) 
    /*2*/  * pow2(gB(m,n))) + gBet_r(m,n) * (1 + (2 * pow2(gA(m,n))) / (gsig(m,n) 
    /*3*/  * pow2(gB(m,n)) * pow2(r(m,n)))) - (2 * gBet(m,n) * pow2(gA(m,n))) 
    /*1*/  / (gsig(m,n) * pow2(gB(m,n)) * pow3(r(m,n)))) + (4 * (gDA(m,n) - gDB(m,n)) 
    /*1*/  * gBet(m,n) * pow2(gA(m,n))) / (gsig(m,n) * pow2(gB(m,n)) * pow3(r(m,n))) 
    /*0*/  + gBet_r(m,n) * ((4 * (-gDA(m,n) + gDB(m,n)) * pow2(gA(m,n))) / (gsig(m,n) 
    /*2*/  * pow2(gB(m,n)) * pow2(r(m,n))) + (6 * pow2(gA(m,n))) / (gsig(m,n) 
    /*2*/  * pow2(gB(m,n)) * pow3(r(m,n))) + 2 / r(m,n)) - (6 * gBet(m,n) 
    /*1*/  * pow2(gA(m,n))) / (gsig(m,n) * pow2(gB(m,n)) * Power(r(m,n),4));
}
Real BimetricEvolve::eq_fDsig_t( Int m, Int n )
{
    return fDsig_r(m,n) * fBet(m,n) + (2 * (fAsig_r(m,n) + 2 * fAsig(m,n) * (fDA(m,n)
    /*3*/  - fDB(m,n))) * fAlp(m,n) * pow2(fA(m,n))) / (fsig(m,n) * pow2(fB(m,n))) 
    /*0*/  + (2 * fAsig(m,n) * fDAlp(m,n) * fAlp(m,n) * pow2(fA(m,n))) / (fsig(m,n) 
    /*1*/  * pow2(fB(m,n))) - (2 * fBet(m,n)) / pow2(r(m,n)) - (2 * fBet_rr(m,n) 
    /*1*/  * pow2(fA(m,n))) / (fsig(m,n) * pow2(fB(m,n)) * pow2(r(m,n))) + fDsig(m,n) 
    /*0*/  * ((-2 * fAsig(m,n) * fAlp(m,n) * pow2(fA(m,n))) / (fsig(m,n) 
    /*2*/  * pow2(fB(m,n))) + fBet_r(m,n) * (1 + (2 * pow2(fA(m,n))) / (fsig(m,n) 
    /*3*/  * pow2(fB(m,n)) * pow2(r(m,n)))) - (2 * fBet(m,n) * pow2(fA(m,n))) 
    /*1*/  / (fsig(m,n) * pow2(fB(m,n)) * pow3(r(m,n)))) + (4 * (fDA(m,n) - fDB(m,n)) 
    /*1*/  * fBet(m,n) * pow2(fA(m,n))) / (fsig(m,n) * pow2(fB(m,n)) * pow3(r(m,n))) 
    /*0*/  + fBet_r(m,n) * ((4 * (-fDA(m,n) + fDB(m,n)) * pow2(fA(m,n))) / (fsig(m,n) 
    /*2*/  * pow2(fB(m,n)) * pow2(r(m,n))) + (6 * pow2(fA(m,n))) / (fsig(m,n) 
    /*2*/  * pow2(fB(m,n)) * pow3(r(m,n))) + 2 / r(m,n)) - (6 * fBet(m,n) 
    /*1*/  * pow2(fA(m,n))) / (fsig(m,n) * pow2(fB(m,n)) * Power(r(m,n),4));
}
