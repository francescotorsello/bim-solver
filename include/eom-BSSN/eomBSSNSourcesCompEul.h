...
Real gJK( Int m, Int n )
{
    ...
    /*2*/  * fconf(m,n)) * fA(m,n) * gAlp(m,n) * pow2(p(m,n)) * P_2_1(R(m,n))) 
    /*0*/  / (TINY_Real + 2 * exp(2 * gconf(m,n)) * gA(m,n) * Lt(m,n)) + ((exp(2 
    /*3*/  * fconf(m,n)) * fA(m,n) * gAlp(m,n) * P_1_1(R(m,n))) / (TINY_Real + exp(2 
    /*3*/  * gconf(m,n)) * gA(m,n)) - (exp(2 * fconf(m,n)) * fA(m,n) * gAlp(m,n) 
    /*2*/  * Lt2(m,n) * P_2_1(R(m,n))) / (TINY_Real + 2 * exp(2 * gconf(m,n)) * gA(m,n))
    /*1*/  + (fAlp(m,n) * (2 * P_1_1(R(m,n)) + P_2_1(R(m,n)))) / (2 + TINY_Real)) 
    /*0*/  / (TINY_Real + Lt(m,n));
}
Real fJK( Int m, Int n )
{
    ...
    /*2*/  * P_2_2(R(m,n)))) / (TINY_Real + 2 * Power(R(m,n),2)) - (exp(2 * gconf(m,n))
    /*1*/  * fAlp(m,n) * gA(m,n) * pow2(p(m,n)) * P_2_1(R(m,n))) / (TINY_Real + 2 
    /*1*/  * exp(2 * fconf(m,n)) * fA(m,n) * Lt(m,n) * Power(R(m,n),2)) + ((gAlp(m,n) 
    /*2*/  * (P_2_1(R(m,n)) + 2 * P_1_2(R(m,n)) * R(m,n))) / (TINY_Real + 2 
    /*2*/  * Power(R(m,n),2)) + (exp(2 * gconf(m,n)) * fAlp(m,n) * gA(m,n) 
    /*2*/  * (-P_1_1(R(m,n)) + P_2_1(R(m,n)))) / (TINY_Real + exp(2 * fconf(m,n)) 
    /*2*/  * fA(m,n) * Power(R(m,n),2)) - (exp(2 * gconf(m,n)) * fAlp(m,n) * gA(m,n) 
    /*2*/  * Lt2(m,n) * P_2_1(R(m,n))) / (TINY_Real + 2 * exp(2 * fconf(m,n)) * fA(m,n)
    /*2*/  * Power(R(m,n),2))) / (TINY_Real + Lt(m,n));
}
