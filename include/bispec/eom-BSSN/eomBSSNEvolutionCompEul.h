...
{
    return k_g * gJK(m,n) + (3 * gAlp_rr(m,n) * (1
    /*2*/  - pow2(r(m,n))) * pow3(r_minus(m,n))) / (TINY_Real + 3
    /*1*/  * (TINY_Real + Power(r_plus(m,n),2) * exp(4 * gconf(m,n))
    /*2*/  * Power(gA(m,n),2))) + gAlp(m,n) * (3
    /*1*/  * pow2(gA1(m,n)) - (4 * gA1(m,n) * gAsig(m,n)
    /*2*/  * pow2(r(m,n))) / (TINY_Real + pow2(r_minus(m,n)))
    /*1*/  + pow2(gtrK(m,n)) / (3 + TINY_Real) + (2
    /*2*/  * pow2(gAsig(m,n)) * Power(r(m,n),4)) / (TINY_Real
    /*2*/  + Power(r_minus(m,n),4))) + gAlp_r(m,n)
    /*0*/  * ((Power(r_minus(m,n),4) * gA_r(m,n)) / (TINY_Real
    /*2*/  + Power(r_plus(m,n),2) * exp(4 * gconf(m,n))
    /*2*/  * Power(gA(m,n),3)) - (2 * Power(r_minus(m,n),4)
    /*2*/  * gB_r(m,n)) / (TINY_Real + Power(r_plus(m,n),2) * exp(4
    /*3*/  * gconf(m,n)) * Power(gA(m,n),2) * gB(m,n)) - (2
    /*2*/  * Power(r_minus(m,n),4)) / (TINY_Real + Power(r_plus(m,n),3)
    /*2*/  * exp(4 * gconf(m,n)) * Power(gA(m,n),2) * r(m,n))
    /*1*/  - (2 * Power(r_minus(m,n),4) * gconf_r(m,n) * (1
    /*3*/  + pow2(r(m,n))) * r(m,n)) / (TINY_Real
    /*2*/  + Power(r_plus(m,n),3) * exp(4 * gconf(m,n))
    /*2*/  * Power(gA(m,n),2) * r(m,n))) + (gBet(m,n)
    /*1*/  * pow3(r_minus(m,n)) * gtrK_r(m,n)) / (-1 + TINY_Real
    /*1*/  + Power(r(m,n),4));
}
Real ftrK_t( Int m, Int n )
{
    return k_f * fJK(m,n) + (3 * fAlp_rr(m,n) * (1
    /*2*/  - pow2(r(m,n))) * pow3(r_minus(m,n))) / (TINY_Real + 3
    /*1*/  * (TINY_Real + Power(r_plus(m,n),2) * exp(4 * fconf(m,n))
    /*2*/  * Power(fA(m,n),2))) + fAlp(m,n) * (3
    /*1*/  * pow2(fA1(m,n)) - (4 * fA1(m,n) * fAsig(m,n)
    /*2*/  * pow2(r(m,n))) / (TINY_Real + pow2(r_minus(m,n)))
    /*1*/  + pow2(ftrK(m,n)) / (3 + TINY_Real) + (2
    /*2*/  * pow2(fAsig(m,n)) * Power(r(m,n),4)) / (TINY_Real
    /*2*/  + Power(r_minus(m,n),4))) + fAlp_r(m,n) * (-((fA_r(m,n)
    /*3*/  * (1 - pow2(r(m,n))) * pow3(r_minus(m,n))) / (TINY_Real
    /*3*/  + Power(r_plus(m,n),2) * exp(4 * fconf(m,n))
    /*3*/  * Power(fA(m,n),3))) + (2 * fB_r(m,n) * (1
    /*3*/  - pow2(r(m,n))) * pow3(r_minus(m,n))) / (TINY_Real
    /*2*/  + Power(r_plus(m,n),2) * exp(4 * fconf(m,n))
    /*2*/  * Power(fA(m,n),2) * fB(m,n)) + (2 * (1
    /*3*/  - pow2(r(m,n))) * pow3(r_minus(m,n))) / (TINY_Real
    /*2*/  + Power(r_plus(m,n),3) * exp(4 * fconf(m,n))
    /*2*/  * Power(fA(m,n),2) * r(m,n)) + (2 * fconf_r(m,n)
    /*2*/  * (1 - pow2(r(m,n))) * pow3(r_minus(m,n)) * (pow3(r(m,n))
    /*3*/  + r(m,n))) / (TINY_Real + Power(r_plus(m,n),3) * exp(4
    /*3*/  * fconf(m,n)) * Power(fA(m,n),2) * r(m,n)))
    /*0*/  - (fBet(m,n) * pow2(r_minus(m,n)) * (1 - pow2(r(m,n)))
    /*1*/  * ftrK_r(m,n)) / (-1 + TINY_Real + Power(r(m,n),4));
}
...
Real gAsig_t( Int m, Int n )
{
    ...
    /*4*/  / ( TINY_Real + r_minus(m,n) ) + (gsig_r(m,n) * (-1 + pow2(r(m,n))) * (-4
    /*6*/  + 4 * pow2(r(m,n)) + gL(m,n) * pow2(gA(m,n))
    /*6*/  * r(m,n))) / r_plus(m,n) - (pow2(r_minus(m,n)) * r(m,n) * (2
    /*6*/  * gsig_r(m,n) * (3 + pow2(r(m,n))) * r(m,n)
    /*6*/  + gsig_rr(m,n) * (-1 + Power(r(m,n),4))))
    ...
    /*5*/  / pow2(r_plus(m,n))) + (gA(m,n) * (Power(r_minus(m,n),4)
    /*6*/  * gAlp_r(m,n) * gA_r(m,n) + exp(4 * gconf(m,n))
    /*6*/  * gAsig_r(m,n) * gBet(m,n) * pow2(r(m,n)) * (1
    /*7*/  + pow2(r(m,n))) * pow3(gA(m,n)) + gA(m,n) * (-1
    /*7*/  + pow2(r(m,n))) * (4 * gconf_r(m,n) * gAlp_r(m,n)
    /*7*/  * pow3(r_minus(m,n)) + gderAlpr_r(m,n) * (pow3(r(m,n))
    /*8*/  + r(m,n))))) / pow2(r_plus(m,n)) - (exp(4 * gconf(m,n))
    /*5*/  * gAsig(m,n) * Power(gA(m,n),4) * r(m,n) * (2
    /*6*/  * gBet(m,n) * (-1 + pow2(r(m,n))) - gAlp(m,n)
    /*6*/  * r(m,n) * gtrK(m,n))) / ( TINY_Real + pow2(r_minus(m,n)) )  )) / (TINY_Real
    /*3*/  + exp(4 * gconf(m,n)) * Power(gA(m,n),4)))) / (2.
    /*1*/  * pow2(r(m,n)));
}
Real fAsig_t( Int m, Int n )
{
    ...
    /*4*/  / ( TINY_Real + r_minus(m,n) ) + (fsig_r(m,n) * (-1 + pow2(r(m,n))) * (-4
    /*6*/  + 4 * pow2(r(m,n)) + fL(m,n) * pow2(fA(m,n))
    /*6*/  * r(m,n))) / r_plus(m,n) - (pow2(r_minus(m,n)) * r(m,n) * (2
    /*6*/  * fsig_r(m,n) * (3 + pow2(r(m,n))) * r(m,n)
    /*6*/  + fsig_rr(m,n) * (-1 + Power(r(m,n),4))))
    ...
    /*5*/  / pow2(r_plus(m,n))) + (fA(m,n) * (Power(r_minus(m,n),4)
    /*6*/  * fAlp_r(m,n) * fA_r(m,n) + exp(4 * fconf(m,n))
    /*6*/  * fAsig_r(m,n) * fBet(m,n) * pow2(r(m,n)) * (1
    /*7*/  + pow2(r(m,n))) * pow3(fA(m,n)) + fA(m,n) * (-1
    /*7*/  + pow2(r(m,n))) * (4 * fconf_r(m,n) * fAlp_r(m,n)
    /*7*/  * pow3(r_minus(m,n)) + fderAlpr_r(m,n) * (pow3(r(m,n))
    /*8*/  + r(m,n))))) / pow2(r_plus(m,n)) - (exp(4 * fconf(m,n))
    /*5*/  * fAsig(m,n) * Power(fA(m,n),4) * r(m,n) * (2
    /*6*/  * fBet(m,n) * (-1 + pow2(r(m,n))) - fAlp(m,n)
    /*6*/  * r(m,n) * ftrK(m,n))) / ( TINY_Real + pow2(r_minus(m,n))  ) )) / (TINY_Real
    /*3*/  + exp(4 * fconf(m,n)) * Power(fA(m,n),4)))) / (2.
    /*1*/  * pow2(r(m,n)));
}
